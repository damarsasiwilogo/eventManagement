    ...
    <>
      {isLoggedIn ? (
        <Box bg={"#331F69"} px={{base: 2, lg:4}}>
          <Flex h={16} alignItems="center" justifyContent={{ lg: "space-between" }}>
      ...
      <Modal isOpen={activeModal === "login"} onClose={closeModal} isCentered>
        ...
        <ModalContent bg="ghostwhite" size="xl">
          <ModalCloseButton />
          <ModalBody>
            <Stack flexDir="column" mt="5" justifyContent="center" alignItems="center">
              <Avatar bg="blue.700" />
              <Heading color="blue.600">Welcome</Heading>
              <Box minW={{ base: "90%", md: "468px" }}>
                <Stack m="3" p="2rem" backgroundColor="transparent">
